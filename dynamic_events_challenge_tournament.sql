...
CREATE TABLE users ('id' int(11) unsigned NOT NULL AUTO_INCREMENT,'user_type' enum('player','coach') DEFAULT NULL,'first_name' varchar(255) DEFAULT NULL,'last_name' varchar(255) DEFAULT NULL,'ranking' tinyint(1) unsigned DEFAULT '3', 'can_play_goalie' tinyint(1) unsigned DEFAULT '0', PRIMARY KEY ('id')) ENGINE=InnoDB DEFAULT CHARSET=utf8;
